        ...
        <div class="wrapper"><img class="layer layer-1" src="/osp/images/Ellipse.svg">
            <div class="hero-inner">
                ...
                <div class="hero-image">
                    <div class="radial-gradient-hero"></div><img class="layer rocket layer-2" src="https://blog.smmkings.io/smmkings/assets/rocketman.svg"> <img class="layer icons layer-3" src="/osp/images/facebook-icon.svg"> <img class="layer icons layer-4" src="/osp/images/fb-like-icon.svg"> <img class="layer icons layer-5" src="/osp/images/instagram-icon.svg"> <img class="layer icons layer-6" src="/osp/images/like-icon.svg"> <img class="layer icons layer-7" src="/osp/images/play-iconm.svg"></div>
            </div>
        </div>
    </div>
    <div class="wrapper">
